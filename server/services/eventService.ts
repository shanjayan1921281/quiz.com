...
export class EventService {
  ...
  public static async getEventById(id: string): Promise<QuizEvent | null> {
    ...
    if (p) {
      ...
      // 3. Fallback for placeholder IDs (e.g. "demo-event-01", "default", "active")
  ...
  public static async createEvent(
    ...
    if (p) {
      ...
      // Link questions in ONE ultra-fast batch query
      if (shuffle) {
        await executeQuery(
  ...
  public static async advanceQuestion(
    ...
    if (p) {
      ...
      // If no questions attached to this event yet, auto-populate from question pool
